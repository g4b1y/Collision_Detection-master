#ifndef __POINT_POLYGON_HPP__
#define __POINT_POLYGON_HPP__
...
namespace level
{
    ...
    private: 
        ...
        inline void collision(sf::CircleShape& c1, sf::ConvexShape& p1) {
            if (col::Collision::PointPolygonCollision(c1, p1)) { 
    ...
    public: 
        inline LVL_Point_Polygon() = default; 

        LVL_Point_Polygon(sf::RenderWindow& window) {
